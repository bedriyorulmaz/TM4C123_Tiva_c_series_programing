...
int main(void){
  ...
  EnableInterrupts();  	// enable interrupts for the grader
	SW1=GPIO_PORTF_DATA_R&0x10;
		ledg=GPIO_PORTF_DATA_R&0x08;
		ledr=GPIO_PORTF_DATA_R&0x04;	
...
// Outputs: None
void WaitForASLow(void){
	do{SW1=GPIO_PORTF_DATA_R&0x10;}
	while(SW1==0x10);				// write this function
}
...
void WaitForASHigh(void){
do{SW1=GPIO_PORTF_DATA_R&0x10;}
	while(SW1==0x00);// write this function
}
